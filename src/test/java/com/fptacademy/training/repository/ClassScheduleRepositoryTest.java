...
class ClassScheduleRepositoryTest {
...
//    }
    ...
    void testDataInit() {
        ...
        Class classTest = classRepository.findById(classFields.getId()).orElse(null);
        ClassDetail classDetail = classDetailRepository.findById(classDetail1.getId()).orElse(null);
        List<Location> locations = locationRepository.findAll();
        List<Attendee> attendees = attendeeRepository.findAll();
        List<ClassSchedule> classSchedules = classScheduleRepository.findAll();
        assertNotNull(user);
        assertNotNull(classTest);
        assertNotNull(classDetail);
        assertEquals(3, locations.size());
        assertEquals(2, attendees.size());
        assertEquals(4, classDetail.getUsers().size());
        assertEquals(5, classSchedules.size());
    }

    @Test
    @DisplayName("Test findActiveClassByStudyDate case 1")
    void findActiveClassByStudyDateShouldReturnAList() {
        List<ClassSchedule> result =
                classScheduleRepository.findActiveClassByStudyDate(LocalDate.of(2023, 3, 17));
        assertNotNull(result);
        assertEquals(1, result.size());
        assertEquals(classSchedule2.getId(), result.get(0).getId());
    }

    @Test
    @DisplayName("Test findActiveClassByStudyDate case 2")
    void findActiveClassByStudyDateShouldReturnEmptyList() {
        List<ClassSchedule> result =
                classScheduleRepository.findActiveClassByStudyDate(LocalDate.of(2023, 3, 18));
        assertNotNull(result);
        assertEquals(0, result.size());
    }

    @Test
    @DisplayName("Test findActiveClassByUserIdAndStudyDate case 1")
    void findActiveClassByUserIdAndStudyDateShouldReturnAList() {

        List<ClassSchedule> result
                = classScheduleRepository
                .findActiveClassByUserIdAndStudyDate(
                        user4.getId(), LocalDate.of(2023, 3, 17)
                );
        assertNotNull(result);
        assertEquals(1, result.size());
    }
    ...
    @Test
    @DisplayName("Test findActiveClassByUserIdAndStudyDate case 2")
    void findActiveClassByUserIdAndStudyDateShouldReturnEmptyList1() {

        List<ClassSchedule> result
                = classScheduleRepository
                .findActiveClassByUserIdAndStudyDate(
                        user5.getId(), LocalDate.of(2023, 3, 18)
                );
        assertNotNull(result);
        assertEquals(0, result.size());
    }
    ...
    @Test
    @DisplayName("Test findActiveClassByUserIdAndStudyDate case 3")
    void findActiveClassByUserIdAndStudyDateShouldReturnEmptyList2() {

        List<ClassSchedule> result
                = classScheduleRepository
                .findActiveClassByUserIdAndStudyDate(
                        user3.getId(), LocalDate.of(2023, 3, 18)
                );
        assertNotNull(result);
        assertEquals(0, result.size());
    }
    ...
    @Test
    @DisplayName("Test findActiveClassByUserIdAndStudyDateBetween case 1")
    void findActiveClassByUserIdAndStudyDateBetweenShouldReturnAList1() {

        List<ClassSchedule> result
                = classScheduleRepository
                .findActiveClassByUserIdAndStudyDateBetween(user4.getId(),
    ...
    @Test
    @DisplayName("Test findActiveClassByUserIdAndStudyDateBetween case 2")
    void findActiveClassByUserIdAndStudyDateBetweenShouldReturnAList2() {
    ...
    @Test
    @DisplayName("Test findActiveClassByUserIdAndStudyDateBetween case 3")
    void findActiveClassByUserIdAndStudyDateBetweenShouldReturnEmptyList() {
    ...
    @Test
    @DisplayName("Test findActiveClassByUserIdAndStudyDateBetween case 1")
    void findActiveClassByStudyDateBetweenShouldReturnAList() {
        List<ClassSchedule> result
                = classScheduleRepository
                .findActiveClassByStudyDateBetween(
                        LocalDate.of(2023, 3, 13),
    ...
    @Test
    void getCurrentClassDayOfClassScheduleShouldReturnAnInt() {
        Integer row = classScheduleRepository.getCurrentClassDayOfClassSchedule(
                classDetail1.getId(),
                classSchedule3.getId());
        assertEquals(3, row);
    }

    @Test
    void getCurrentClassDayOfClassScheduleShouldReturnAnInt1() {
        Integer row = classScheduleRepository.getCurrentClassDayOfClassSchedule(
                100L,
                classSchedule3.getId());
        assertNull(row);
